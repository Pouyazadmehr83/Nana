...
export const PawIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 11c1.5 0 3 .8 3 2.5 0 2.2-2 4.5-3 4.5s-3-2.3-3-4.5C9 11.8 10.5 11 12 11z" />
    <path d="M8.5 7.5a2 2 0 1 0-3-2.6 2 2 0 0 0 3 2.6z" />
    <path d="M18.5 7.5a2 2 0 1 1-3-2.6 2 2 0 0 1 3 2.6z" />
    <path d="M5.5 12a1.8 1.8 0 1 0-2.6-2.5 1.8 1.8 0 0 0 2.6 2.5z" />
    <path d="M21.1 12a1.8 1.8 0 1 1-2.6-2.5 1.8 1.8 0 0 1 2.6 2.5z" />
  </svg>
);
...
export const HeartIcon = ({ size = 20, fill = 'none', ...props }: IconProps & { fill?: string }) => (
...
export const ShieldCheckIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M20 13c0 5-8 9-8 9s-8-4-8-9V5l8-3 8 3v8Z" />
...
export const GiftIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
